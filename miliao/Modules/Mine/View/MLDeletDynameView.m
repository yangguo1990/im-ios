...
@implementation MLDeletDynameView
...
+(instancetype)alterViewWithTitle:(NSString *)title
    ...
    MLDeletDynameView *alterView=[[MLDeletDynameView alloc]initWithFrame:CGRectMake(0, 0, WIDTH-80, 200)];
