...
@interface MLEditZhaoHuView()<UITextViewDelegate>
...
@property (nonatomic,copy)UILabel *lengthlabel;


@end

@implementation MLEditZhaoHuView
...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.textView.textColor =  [UIColor colorWithRed:136/255.0 green:136/255.0 blue:136/255.0 alpha:1.0];
...
+(instancetype)alterVietextviewStrblock:(textviewStrBlock)textviewStrblock
    ...
    MLEditZhaoHuView *alterView=[[MLEditZhaoHuView alloc]initWithFrame:CGRectMake(0, 0, WIDTH-80, 200)];
    ...
    alterView.indextitlelabel.text = lengthstr;
...
-(void)setTextView:(UITextView *)textView{
    _textView = textView;
    NSLog(@"000000%@",textView.text);
   // self.indextitlelabel.text = [NSString stringWithFormat:@"%lu/",(unsigned long)self.length.length];
}

-(void)setLengthlabel:(UILabel *)lengthlabel{
    _lengthlabel = lengthlabel;
}

-(void)setIndextitlelabel:(UILabel *)indextitlelabel{
