...
@interface ML_FriendToViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ML_FriendToViewController
...
-(void)giveML_focusApi{
    kSelf;
    MLGetUserAccessLogsApi *api = [[MLGetUserAccessLogsApi alloc]initWithtoken:[ML_AppUserInfoManager sharedManager].currentLoginUserData.token type:@"0" page:@(self.ML_Page) limit:@"20" extra:[self jsonStringForDictionary]];
