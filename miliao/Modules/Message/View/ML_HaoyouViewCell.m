...
@implementation ML_HaoyouViewCell
...
//    }];
    ...
    UILabel *nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(80, 16, 200, 22)];
    self.nameLabel.textAlignment = NSTextAlignmentLeft;
    nameLabel.font = [UIFont boldSystemFontOfSize:16];
    nameLabel.textColor = [UIColor colorFromHexString:@"#333333"];
//    [nameLabel setTitleColor:[UIColor colorFromHexString:@"#333333"] forState:UIControlStateNormal];
    ...
    [ciytView setTextColor:[UIColor colorWithHexString:@"#8C8C8C"]];
...
//    }];
    ...
    adrrnameLabel.textAlignment = NSTextAlignmentRight;
...
//        make.bottom.mas_equalTo(self.mas_right).mas_offset(-16);
...
//
    ...
    tnameLabel.backgroundColor = kGetColor(@"#FB4240");
    tnameLabel.font = [UIFont systemFontOfSize:12 weight:UIFontWeightRegular];
...
-(void)setDict:(NSDictionary *)dict{
    ...
    self.cityView.text = [NSString stringWithFormat:@"%@", dict[@"persionSign"]?:@""];
    [self.cityView sizeToFit];
    self.cityView.frame = CGRectMake(80, 60 - 6 - 18, self.cityView.width +5, 18);
    self.adrrnameLabel.text = [NSString stringWithFormat:@"%@", dict[@"time"]?:@"2022-07-20"];
//    [self.adrrnameLabel sizeToFit];
    CGSize size = [self.adrrnameLabel.text sizeWithFont:self.adrrnameLabel.font maxSize:CGSizeMake(ML_ScreenWidth - 140, 18)];
    self.adrrnameLabel.frame = CGRectMake(ML_ScreenWidth - 16 - size.width, 6, size.width, 18);
    
    self.tnameLabel.text = @"99+";
    [self.tnameLabel sizeToFit];
    self.tnameLabel.frame = CGRectMake(ML_ScreenWidth - 16 - self.tnameLabel.width -15, 60 - 6 - 20, self.tnameLabel.width + 15, 20);
    self.tnameLabel.layer.cornerRadius = self.tnameLabel.height / 2;
    self.tnameLabel.clipsToBounds = YES;
    
    if ([dict[@"type"] intValue] < 0) {
        self.agebtn.selected = NO;
        self.agebtn2.selected = NO;
    } else if ([dict[@"type"] intValue] == 0) {
        self.agebtn.selected = NO;
    ...
    self.bg.hidden = YES;
    self.nameLabel.text = dict[@"name"]?:@"123";
//    [self.nameLabel setTitle:[NSString stringWithFormat:@"%@", dict[@"name"]?:@"123"] forState:UIControlStateNormal];
...
//    }
     ...
     CGSize size2 = [self.nameLabel.text sizeWithFont:self.nameLabel.font maxSize:CGSizeMake(110, 22)];
     self.nameLabel.frame = CGRectMake(80, 6, size2.width + 30, 24);
