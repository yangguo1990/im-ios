...
-(void)setupView{
    ...
    [_mSelImageBtn setTitle:Localized(@"sel_Photo",nil) forState:UIControlStateNormal];
    ...
    [_mSelVideoBtn setTitle:Localized(@"sel_Video",nil) forState:UIControlStateNormal];
    ...
    _mLablel.text = Localized(@"Choose_photo_or_video_from_your_album",nil);
