...
-(void)awakeFromNib {
    ...
    [self.skinBtn setTitle:Localized(@"美肤", nil) forState:UIControlStateNormal];
    [self.shapeBtn setTitle:Localized(@"美型", nil) forState:UIControlStateNormal];
    [self.beautyFilterBtn setTitle:Localized(@"滤镜", nil) forState:UIControlStateNormal];
    [self.mRestBtn setTitle:Localized(@"恢复", nil) forState:UIControlStateNormal];
