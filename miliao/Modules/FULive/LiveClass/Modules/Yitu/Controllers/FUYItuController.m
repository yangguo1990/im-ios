...
-(void)setupView{
    ...
    [self showMessage:Localized(@"动动你的五官", nil)];
...
//        }
    ...
    [self.delBtn setTitle:Localized(@"删除道具", nil)  forState:UIControlStateNormal];
...
//    [delBtn setTitleColor:[UIColor colorWithRed:31/255.0 green:178/255.0 blue:255/255.0 alpha:1.0] forState:UIControlStateHighlighted];
    ...
    [self.reEditBt setTitle:Localized(@"重新编辑", nil) forState:UIControlStateNormal];
