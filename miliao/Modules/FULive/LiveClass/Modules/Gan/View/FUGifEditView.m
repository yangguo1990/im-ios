...
-(void)setupView{
    ...
    NSMutableAttributedString *string1 = [[NSMutableAttributedString alloc] initWithString:Localized(@"播放",nil) attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10],NSForegroundColorAttributeName: [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0]}];
    [_playBtn setTitle:Localized(@"播放",nil) forState:UIControlStateNormal];
    ...
    NSMutableAttributedString *string2 = [[NSMutableAttributedString alloc] initWithString:Localized(@"加速",nil)  attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10],NSForegroundColorAttributeName: [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0]}];
    ...
    [_quickenBtn setTitle:Localized(@"加速",nil) forState:UIControlStateNormal];
