...
-(void)initializationData{
    FUExpressionMode *model9 = [FUExpressionMode getClassTitle:Localized(@"原图", nil)  imageStr:@"icon_gan_original"];
    FUExpressionMode *model0 = [FUExpressionMode getClassTitle:Localized(@"微笑", nil) imageStr:@"icon_gan_smile"];
    FUExpressionMode *model1 = [FUExpressionMode getClassTitle:Localized(@"露齿笑", nil) imageStr:@"icon_gan_laugh"];
    FUExpressionMode *model2 = [FUExpressionMode getClassTitle:Localized(@"大笑", nil) imageStr:@"icon_gan_grin"];
    FUExpressionMode *model3 = [FUExpressionMode getClassTitle:Localized(@"左闭眼", nil) imageStr:@"icon_gan_left_close_eyes"];
    FUExpressionMode *model4 = [FUExpressionMode getClassTitle:Localized(@"右闭眼", nil) imageStr:@"icon_gan_right_close_eyes"];
    FUExpressionMode *model5 = [FUExpressionMode getClassTitle:Localized(@"生气", nil) imageStr:@"icon_gan_angry"];
    FUExpressionMode *model6 = [FUExpressionMode getClassTitle:Localized(@"伤感", nil) imageStr:@"icon_gan_sad"];
    FUExpressionMode *model7 = [FUExpressionMode getClassTitle:Localized(@"左邪魅", nil) imageStr:@"icon_gan_left_demon"];
    FUExpressionMode *model8 = [FUExpressionMode getClassTitle:Localized(@"右邪魅", nil) imageStr:@"icon_gan_right_demon"];
