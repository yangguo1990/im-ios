...
-(void)awakeFromNib {
    ...
    [_noitemBtn setTitle:Localized(@"自定义",nil)  forState:UIControlStateNormal];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (collectionView == self.bottomCollection) {
        ...
        cell.name.text = Localized(model.name, nil);
    ...
    if (_isOpen) {
        ...
        cell.mLabel.text = Localized(_supArray[indexPath.row].name, nil);;
