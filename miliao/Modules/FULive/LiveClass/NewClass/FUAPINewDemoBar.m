...
@interface FUAPINewDemoBar ()<FUFilterViewDelegate, FUBeautyViewDelegate>
...
@implementation FUAPINewDemoBar
...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {self.backgroundColor = [UIColor clearColor];
        ...
        NSBundle *bundle = [NSBundle bundleForClass:[FUAPINewDemoBar class]];
        self = (FUAPINewDemoBar *)[bundle loadNibNamed:@"FUAPINewDemoBar" owner:self options:nil].firstObject;
        self.frame = frame;
    }
    return self ;
}
