...
- (NSString *)getAMText {
    return [NSBundle br_localizedStringForKey:Localized(@"上午", nil) language:self.pickerStyle.language];
}

- (NSString *)getPMText {
    return [NSBundle br_localizedStringForKey:Localized(@"下午", nil) language:self.pickerStyle.language];
}
...
- (NSString *)getYearUnit {
    ...
    return [NSBundle br_localizedStringForKey:Localized(@"年", nil) language:self.pickerStyle.language];
}
...
- (NSString *)getMonthUnit {
    ...
    return [NSBundle br_localizedStringForKey:Localized(@"月", nil) language:self.pickerStyle.language];
}
...
- (NSString *)getDayUnit {
    ...
    return [NSBundle br_localizedStringForKey:Localized(@"日", nil) language:self.pickerStyle.language];
}
...
- (NSString *)getSecondUnit {
    ...
    return [NSBundle br_localizedStringForKey:Localized(@"秒", nil) language:self.pickerStyle.language];
}
