...
- (NSString *)cancelBtnTitle {
    if (!_cancelBtnTitle && !_cancelBtnImage) {
        _cancelBtnTitle = [NSBundle br_localizedStringForKey:Localized(@"取消", nil) language:self.language];
    }
...
- (NSString *)doneBtnTitle {
    if (!_doneBtnTitle && !_doneBtnImage) {
        _doneBtnTitle = [NSBundle br_localizedStringForKey:Localized(@"确定", nil) language:self.language];
    }
...
+ (instancetype)pickerStyleWithDoneTextColor:(UIColor *)doneTextColor {
    ...
    if (doneTextColor) {
        ...
        customStyle.doneBtnTitle = [NSBundle br_localizedStringForKey:Localized(@"完成", nil) language:customStyle.language];
