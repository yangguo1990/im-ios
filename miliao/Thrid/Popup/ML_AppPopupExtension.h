...
@interface ML_AppPopupExtension : NSObject

/* WorkplaceApppPopupDataSource */
...
@class WorkplaceApppPopupPoolBridge;
@interface WorkplaceApppPopupPool : NSObject
//已经弹出的弹窗，弱引用记录
@property(nonatomic,strong)NSMutableArray <WorkplaceApppPopupPoolBridge *>*pool;
...
@interface WorkplaceApppPopupPoolBridge : NSObject
