...
- (void)viewDidLoad {
    ...
    _timeListNameArray = @[@"定时关闭",@"不开启",@"播完当前音频后",@"播完2段音频后",@"播完3段音频后",@"10分钟后",@"20分钟后",@"30分钟后",Localized(@"取消", nil)];
...
//    }
    ...
    _middlePlayView = [[UIView alloc]initWithFrame:CGRectMake(0, XHScreenHeight - SafeAreaBottomHeight - 160, XHScreenHeight, 160)];
    ...
    _topBGImageView.frame = CGRectMake(0, 0, XHScreenWidth, XHScreenHeight - 160 - SafeAreaBottomHeight);
...
//    self.topBGImageView.image = [columnImage blurImage];
    [self.topBGImageView sd_setImageWithURL:[NSURL URLWithString:_currentModel.audioPic] placeholderImage:kPlaceImage];
