...
//        CGFloat wh = self.bounds.size.width - 2 * x;
        ...
        CGFloat wh = 134 * screenH / screenW;
        
        CGFloat y = 100;
        UIImageView *logoView = [[UIImageView alloc] initWithFrame:CGRectMake(x, y, 90, 160)];
...
- (void)shrinkSuspensionViewAnimationWithComplete:(void (^)(void))complete {
    ...
    [self.targetVC.navigationController setNavigationBarHidden:YES];
    [JPSEInstance.navCtr setNavigationBarHidden:YES];
