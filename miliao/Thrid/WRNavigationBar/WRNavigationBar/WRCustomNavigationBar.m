...
+ (instancetype)CustomNavigationBar {
    WRCustomNavigationBar *navigationBar = [[self alloc] initWithFrame:CGRectMake(0, 0, kWRScreenWidth, ML_NavViewHeight + 5)];
...
-(void)updateFrame
{
    NSInteger top = (SSL_isFullScreen) ? 44 : 20;
    NSInteger margin = 0;
    NSInteger buttonHeight = 44;
    NSInteger buttonWidth = 44;
    NSInteger titleLabelHeight = 44;
    NSInteger titleLabelWidth = ML_ScreenWidth - 100;
...
- (void)setTitleLabelColorTextAlignment:(NSTextAlignment)titleLabelColorTextAlignment
{
    self.titleLable.textAlignment = titleLabelColorTextAlignment;
}
