...
- (void)hide {
    ...
    if ([[UIViewController topShowViewController] isKindOfClass:[MLCommunityViewController class]]) {
        [[NSNotificationCenter defaultCenter] postNotificationName:@"ML_ShowTabar" object:nil];
    }
}
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath{
    id<YBIBDataProtocol> data = [self.dataMediator dataForCellAtIndex:indexPath.row];
    ((UICollectionViewCell<YBIBCellProtocol>*)cell).yb_cellData = data;
}
