...
- (void)getLineSpacingLabelWithString:(NSString *)text X:(CGFloat)x Y:(CGFloat)y Width:(CGFloat)maxWidth Font:(CGFloat)fontSize LineSpace:(CGFloat)lineSpace
{
    // 设置label的属性
...
//    [Utils setFontFamily:appDelegate.customFontName forView:self andSubViews:YES];
