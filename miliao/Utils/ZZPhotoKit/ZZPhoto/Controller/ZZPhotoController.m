...
-(UINavigationController *)photoListNavigationController{
    if (!_photoListNavigationController) {
        ...
        _photoListNavigationController.navigationBar.barTintColor = UIColor.whiteColor;
    }
...
-(void)showController:(UIViewController *)controller result:(ZZPhotoResult)result
{
    ...
    self.photoListController.modalPresentationStyle = UIModalPresentationFullScreen;
...
{
    self.photoListNavigationController.modalPresentationStyle = UIModalPresentationFullScreen;
