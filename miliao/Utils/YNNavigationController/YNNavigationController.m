...
- (void)panGesListener:(UIPanGestureRecognizer *)panGes{
    ...
    if (panGes.state == UIGestureRecognizerStateBegan) {
        ...
        if (pt.x >= 10) {
            ...
            shotView.NmaskView.backgroundColor = [UIColor colorWithHue:0 saturation:0 brightness:0 alpha:-pt.x / __YNScreenWidth * 0.4 + self.maskViewAlpha];
        ...
        if (pt.x >= self.distanceLeft) {
            ...
            [UIView animateWithDuration:self.animationTime animations:^{
                ...
                shotView.NmaskView.backgroundColor = [UIColor colorWithHue:0 saturation:0 brightness:0 alpha:0];
            ...
            [UIView animateWithDuration:self.animationTime animations:^{
                shotView.NmaskView.backgroundColor = [UIColor colorWithHue:0 saturation:0 brightness:0 alpha:self.maskViewAlpha];
                topView.transform = CGAffineTransformIdentity;
                if (self.shotViewAnimationType == ShotViewAnimationTypeScale) {
...
- (void)setHasMaskView:(BOOL)hasMaskView{
    ...
    YN_SHOTVIEW.NmaskView.hidden = !hasMaskView;
}
...
- (void)popAnimationWithPopViewControllerType:(PopViewControllerType)type toViewController:(UIViewController *)toViewController completionBlock:(AnimationCompletion)animationCompletion animated:(BOOL)animated{
    ...
    YN_SHOTVIEW.NmaskView.backgroundColor = [UIColor colorWithHue:0 saturation:0 brightness:0 alpha:self.maskViewAlpha];
    [UIView animateWithDuration:self.animationTime animations:^{
        ...
        YN_SHOTVIEW.NmaskView.backgroundColor = [UIColor colorWithHue:0 saturation:0 brightness:0 alpha:0.0];
    } completion:^(BOOL finished) {
...
- (void)pushAnimationWithViewController:(UIViewController *)viewController isFullPush:(BOOL)isFullPush{
    ...
    if (isFullPush) {
        ...
        YN_SHOTVIEW.NmaskView.backgroundColor = [UIColor colorWithHue:0 saturation:0 brightness:0 alpha:0];
