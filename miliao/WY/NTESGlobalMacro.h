...
#define SSL_isFullScreen (UIScreenHeight == 812.0f || UIScreenHeight == 896.0f)
#define UITabbarHeight (SSL_isFullScreen ? 49 + 20 : 49)
...
#define NTESLocalizedString(key) Localized((key),nil)
#endif
