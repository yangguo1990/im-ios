...
@interface NIMSessionListViewController : ML_BaseVC<UITableViewDataSource,UITableViewDelegate,NIMLoginManagerDelegate,NIMConversationManagerDelegate>
/**
 *  会话列表tableView
 */
@property (nonatomic,strong)   UITableView *tableView;

@property (nonatomic,assign) BOOL isBadgeViewHi; // 暂时 可能可以不要了
/**
 *  最近会话集合
 */
