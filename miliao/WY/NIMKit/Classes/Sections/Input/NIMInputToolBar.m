...
//        [self setBackgroundColor:[UIColor whiteColor]];
        ...
        [_voiceButton setBackgroundImage:[UIImage nim_imageInKit:@"icon_toolview_voice_normal2"] forState:UIControlStateNormal];
//        [_voiceButton setBackgroundImage:[UIImage nim_imageInKit:@"icon_toolview_voice_pressed2"] forState:UIControlStateHighlighted];
        [_voiceButton sizeToFit];
        //
        
        _emoticonBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [_emoticonBtn setBackgroundImage:[UIImage nim_imageInKit:@"icon_toolview_emotion_normal"] forState:UIControlStateNormal];
//        [_emoticonBtn setBackgroundImage:[UIImage nim_imageInKit:@"icon_toolview_emotion_pressed"] forState:UIControlStateHighlighted];
        ...
        [_recordButton setBackgroundImage:[[UIImage imageNamed:@"Group 1801"] resizableImageWithCapInsets:UIEdgeInsetsMake(15,80,15,80) resizingMode:UIImageResizingModeStretch] forState:UIControlStateNormal];
//        _recordButton.backgroundColor = [UIColor redColor];
        ...
        [_inputTextBkgImage setImage:[[UIImage imageNamed:@"Group 1801"] resizableImageWithCapInsets:UIEdgeInsetsMake(15,80,15,80) resizingMode:UIImageResizingModeStretch]];
        _inputTextView = [[NIMGrowingTextView alloc] initWithFrame:CGRectZero];
        _inputTextView.font = [UIFont systemFontOfSize:16.0f weight:UIFontWeightMedium];
...
{
//    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"icon_toolview_voice_normal2"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_normal2"] forState:UIControlStateNormal];
    [self.voiceButton setBackgroundImage:selected?[UIImage nim_imageInKit:@"icon_toolview_voice_normal2"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_pressed2"] forState:UIControlStateNormal];
}

- (void)updateEmotAndTextBtnImages:(BOOL)selected
{
    [self.emoticonBtn setImage:selected?[UIImage nim_imageInKit:@"icon_toolview_emotion_normal"]:[UIImage imageNamed:@"icon_toolview_keyboard_normal"] forState:UIControlStateNormal];
//    [self.emoticonBtn setImage:selected?[UIImage nim_imageInKit:@"icon_toolview_emotion_pressed"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_pressed2"] forState:UIControlStateHighlighted];
}
...
- (void)setPlaceHolder:(NSString *)placeHolder
{
    ...
    self.inputTextView.placeholderAttributedText = [[NSAttributedString alloc] initWithString:placeHolder attributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#999999"], NSFontAttributeName:[UIFont systemFontOfSize:16 weight:UIFontWeightMedium]}];
}
