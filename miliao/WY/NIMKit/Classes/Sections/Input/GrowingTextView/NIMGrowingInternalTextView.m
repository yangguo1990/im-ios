...
- (void)drawRect:(CGRect)rect
{
    ...
    self.font = [UIFont systemFontOfSize:16 weight:UIFontWeightMedium]; // 字重
    CGRect targetRect = CGRectMake(7, 9.5 + self.contentInset.top, self.frame.size.width - self.contentInset.left, self.frame.size.height - self.contentInset.top);
    self.wzb_placeholderColor = [UIColor colorWithHexString:@"#999999"];
