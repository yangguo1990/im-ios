...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:Localized(@"完成", nil).nim_localized style:UIBarButtonItemStyleDone target:self action:@selector(onDone:)];
