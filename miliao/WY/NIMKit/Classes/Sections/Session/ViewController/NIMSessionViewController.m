...
{ 
    ...
    CGRect frame = CGRectMake(0, ML_NavViewHeight, ML_ScreenWidth, ML_ScreenHeight - ML_NavViewHeight - ML_TabbarHeight);
...
//        _advanceMenu = [[NIMAdvanceMenu alloc] initWithFrame:CGRectMake(0, 0, 320, 190) emotions:self.sessionConfig.emotionItems*];
        _advanceMenu = [[NIMAdvanceMenu alloc] initWithFrame:CGRectMake(0, 0, 320, 100) emotions:nil];
