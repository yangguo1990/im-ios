...
- (void)showOperationsForMessage:(NIMMessage *)message
{
    ...
    if (message.messageType == NIMMessageTypeText) {
        [alertController addAction:[UIAlertAction actionWithTitle:Localized(@"复制", nil).nim_localized style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
    ...
    [alertController addAction:[UIAlertAction actionWithTitle:Localized(@"取消", nil).nim_localized style:UIAlertActionStyleCancel handler:nil]];
