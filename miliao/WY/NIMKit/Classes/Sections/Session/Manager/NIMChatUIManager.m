...
{
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:Localized(@"选择会话类型", nil) message:nil preferredStyle:UIAlertControllerStyleActionSheet];
    [alertController addAction:[UIAlertAction actionWithTitle:Localized(@"个人", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
    ...
    [alertController addAction:[UIAlertAction actionWithTitle:Localized(@"群组", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
    ...
    [alertController addAction:[UIAlertAction actionWithTitle:Localized(@"超大群组", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        NIMContactTeamSelectConfig *config = [[NIMContactTeamSelectConfig alloc] init];
    ...
    [alertController addAction:[UIAlertAction actionWithTitle:Localized(@"取消", nil) style:UIAlertActionStyleCancel handler:nil]];
...
- (void)forwardMessage:(NIMMessage *)message toSession:(NIMSession *)session fromViewController:(UIViewController *)fromVC
{
    ...
    [alertController addAction:[UIAlertAction actionWithTitle:Localized(@"取消", nil) style:UIAlertActionStyleCancel handler:nil]];
    [alertController addAction:[UIAlertAction actionWithTitle:Localized(@"确认", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        NSError *error = nil;
        if (message.session) {
        ...
        if (error) {
            ...
            [fromVC.view nim_showToast:Localized(@"已发送", nil) duration:2.0];
        }
    }]];
    [fromVC presentViewController:alertController animated:YES completion:nil];
}
