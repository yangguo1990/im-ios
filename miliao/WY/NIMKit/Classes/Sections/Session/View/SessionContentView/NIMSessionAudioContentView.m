...
- (void)refresh:(NIMMessageModel *)data {
    ...
    {
        self.voiceImageView.transform = CGAffineTransformMakeRotation(180 *2*M_PI / 180.0);
    } else {
        self.voiceImageView.transform = CGAffineTransformMakeRotation(180 * M_PI / 180.0);

    }
    CGAffineTransform transform = self.voiceImageView.transform;
...
//        color = [UIColor colorWithHex:0x1A73E0 alpha:1];
        color = [UIColor colorWithHexString:@"#D5C8FF"];
    }
