...
- (void)setupUI {
    UIBarButtonItem *doneItem = [[UIBarButtonItem alloc] initWithTitle:Localized(@"完成", nil) style:UIBarButtonItemStyleDone target:self action:@selector(doneItemClicked:)];
