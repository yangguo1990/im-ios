...
- (void)addCustomNotification:(id)sender{
    ...
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:@"选择操作".ntes_localized delegate:nil cancelButtonTitle:Localized(@"取消", nil).ntes_localized destructiveButtonTitle:nil otherButtonTitles:@"单聊".ntes_localized,@"群组".ntes_localized,@"超大群组".ntes_localized, nil];
...
- (void)didFinishedSelect:(NSArray *)selectedContacts{
    ...
    [[vc addAction:Localized(@"确认", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
