...
- (NSArray *)groupAbove
{
    ...
    [@[
       ...
       @{
           ...
           contactCellUtilTitle:Localized(@"黑名单", nil).ntes_localized,
...
- (void)onOpera:(id)sender{
    ...
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:@"选择操作".ntes_localized delegate:nil cancelButtonTitle:Localized(@"取消", nil).ntes_localized destructiveButtonTitle:nil otherButtonTitles:@"添加好友".ntes_localized,@"创建高级群".ntes_localized,@"创建讨论组".ntes_localized,@"搜索高级群".ntes_localized,nil];
