...
- (void)buildData{
    ...
    NSArray *data = @[
                      ...
                      @{
                          ...
                          RowContent :@[
                                  @{
                                      Title      : Localized(@"昵称", nil).ntes_localized,
                                  ...
                                  @{
                                      Title      : Localized(@"性别", nil).ntes_localized,
...
- (void)onTouchPortrait:(id)sender{
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:Localized(@"设置头像", nil) delegate:nil cancelButtonTitle:Localized(@"取消", nil).ntes_localized destructiveButtonTitle:nil otherButtonTitles:Localized(@"拍照", nil), Localized(@"从相册", nil), nil];
        ...
        UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:Localized(@"设置头像", nil) delegate:nil cancelButtonTitle:Localized(@"取消", nil).ntes_localized destructiveButtonTitle:nil otherButtonTitles:Localized(@"从相册", nil), nil];
        [sheet showInView:self.view completionHandler:^(NSInteger index) {
            switch (index) {
                case 0:
                    [self showImagePicker:UIImagePickerControllerSourceTypePhotoLibrary];
