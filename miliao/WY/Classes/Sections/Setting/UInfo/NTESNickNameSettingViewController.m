...
- (void)setUpNav{
    self.navigationItem.title = Localized(@"昵称", nil).ntes_localized;
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:Localized(@"完成", nil).ntes_localized style:UIBarButtonItemStyleDone target:self action:@selector(onDone:)];
