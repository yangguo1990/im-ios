    ...
    NSArray *data = @[
                      ...
                      @{
                          ...
                          RowContent :@[
                                  ...
                                  @{
                                      Title         : Localized(@"我的钱包", nil).ntes_localized,
                       ...
                       @{
                          ...
                          RowContent :@[
                                        ...
                                        @{
                                            Title      :Localized(@"清理缓存", nil).ntes_localized,
...
- (void)onTouchShowLog:(id)sender{
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:@"查看日志".ntes_localized delegate:nil cancelButtonTitle:Localized(@"取消", nil).ntes_localized destructiveButtonTitle:nil otherButtonTitles:@"查看 DEMO 配置".ntes_localized,@"查看 SDK 日志".ntes_localized,@"查看 Demo 日志".ntes_localized, nil];
    ...
    [[vc addAction:@"清除".ntes_localized style:UIAlertActionStyleDestructive handler:^(UIAlertAction *action) {
        ...
        [[NIMSDK sharedSDK].resourceManager removeResourceFiles:option completion:^(NSError * _Nullable error, long long freeBytes) {
            ...
            if (error)
            {
                ...
                [result addAction:Localized(@"确定", nil).ntes_localized style:UIAlertActionStyleCancel handler:nil];
                [result show];
            }
            else
            {
     ...
     addAction:Localized(@"取消", nil).ntes_localized style:UIAlertActionStyleCancel handler:nil];
...
- (void)logoutCurrentAccount:(id)sender{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle: Localized(@"退出当前帐号？", nil).ntes_localized message:nil delegate:nil cancelButtonTitle:Localized(@"取消", nil).ntes_localized otherButtonTitles:Localized(@"确定", nil).ntes_localized, nil];
