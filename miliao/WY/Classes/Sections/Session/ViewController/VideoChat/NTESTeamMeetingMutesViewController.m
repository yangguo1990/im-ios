...
- (void)setUpNav
{
    ...
    self.navigationItem.leftBarButtonItem  = [[UIBarButtonItem alloc] initWithTitle:Localized(@"取消", nil).ntes_localized style:UIBarButtonItemStylePlain target:self action:@selector(cancel:)];
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:Localized(@"完成", nil).ntes_localized style:UIBarButtonItemStylePlain target:self action:@selector(done:)];
}
