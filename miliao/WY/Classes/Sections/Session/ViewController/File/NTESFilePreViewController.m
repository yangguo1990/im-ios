...
- (void)openWithOtherApp{
    ...
    {
        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"" message:@"未找到打开该应用的程序".ntes_localized delegate:nil cancelButtonTitle:Localized(@"确定", nil).ntes_localized otherButtonTitles: nil];
        [alert show];
    }
}
